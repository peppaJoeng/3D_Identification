function ID_by_category_4_euclidean(Y_path, modeldir,result_mat)
%ID_BY_CATEGORY 
%   Calculate the average correlation coefficient based on the attack category
disp(modeldir);
cla = ["smooth", "noise", "quantization", "simplification","cropping","subdivision"];
intensity = {["iteration5_","iteration10_","iteration30_","iteration50_"];...
    ["0.0005", "0.0010", "0.0030", "0.0050"];...
    ["10","9","8","7"];...
    ["ratio50.0","ratio70.0","ratio90.0","ratio95.0", "ratio97.5"];...
    ["ratio10.0","ratio30.0","ratio50.0"];...
    ["loop","midpoint","sqrt3"];
    };
