...
def ROC(path):
    ...
    TNR = []
    Thred = []
    for thred in np.arange(0, 0.015, 0.0001):
        Thred.append(thred)
        # print(thred)
...
if __name__ == '__main__':
    distance_LR = [
        'LR/distance_HM25_crop5_LR_1.csv',
        'LR/distance_HM25_noise_1_LR_1.csv',
        'LR/distance_HM25_quan_7_LR_1.csv',
        'LR/distance_HM25_reorder_LR_1.csv',
        'LR/distance_HM25_si_10_LR_1.csv',
        'LR/distance_HM25_sm_10_LR_1.csv',
        'LR/distance_HM25_st1_LR_1.csv',
    ]

    [TPR, FPR, Thred] = allRate(distance_LR)
